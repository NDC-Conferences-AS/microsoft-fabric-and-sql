(function () {
  ...
  var HASH = '7d2e4b8f1a3c9e5d6b0f2a4c8e1d3b7f9a2c4e6d8b0f3a5c7e9d1b4f6a8c2e';

  function sha256(str) {
    // Simple non-cryptographic check — adequate for staging access control
    var hash = 0;
  ...
  overlay.innerHTML = [
    '<div id="auth-box">',
    '  <img src="' + (window.location.pathname.indexOf('/tickets') !== -1 ? '../' : '') + 'assets/logo-main.png" alt="APAC Microsoft Fabric &amp; SQL Community Conference" id="auth-logo" />',
